...
game.States.boot = function() {
    this.preload = function() {
        ...
        game.load.image('loading', '/static/game_flappy/assets/preloader.gif');
    };
...
game.States.preload = function() {
    this.preload = function() {
        ...
        //以下为要加载的资源
        game.load.image('background', '/static/game_flappy/assets/background.png'); //背景
        game.load.image('ground', '/static/game_flappy/assets/ground.png'); //地面
        game.load.image('sky', '/static/game_flappy/assets/ground.png'); //sky?
        game.load.image('title', '/static/game_flappy/assets/title.png'); //游戏标题
        game.load.spritesheet('bird', '/static/game_flappy/assets/bird.png', 34, 24, 3); //鸟
        game.load.image('btn', '/static/game_flappy/assets/start-button.png'); //按钮
        game.load.spritesheet('pipe', '/static/game_flappy/assets/pipes.png', 54, 320, 2); //管道
        game.load.bitmapFont('flappy_font', '/static/game_flappy/assets/fonts/flappyfont/flappyfont.png', '/static/game_flappy/assets/fonts/flappyfont/flappyfont.fnt');
        game.load.audio('fly_sound', '/static/game_flappy/assets/flap.mp3'); //飞翔的音效
        game.load.audio('score_sound', '/static/game_flappy/assets/score.mp3'); //得分的音效
        game.load.audio('hit_pipe_sound', '/static/game_flappy/assets/pipe-hit.mp3'); //撞击管道的音效
        game.load.audio('hit_ground_sound', '/static/game_flappy/assets/ouch.mp3'); //撞击地面的音效

        game.load.image('ready_text', '/static/game_flappy/assets/get-ready.png');
    ...
    this.showGameOverText = function() {
        ...
        if (this.score > game.bestScore) {
            ...
            fetch("/game-flappy/set-result/", {
                ...
                body: JSON.stringify(game.bestScore)
            })
        }
